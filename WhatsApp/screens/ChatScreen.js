...
import { View, Text, StyleSheet, Button, ImageBackground, TouchableOpacity, KeyboardAvoidingView, Platform, TextInput, FlatList, Image, ActivityIndicator } from 'react-native';

import backgroundImage from "../assets/images/droplet4.jpg"
...
import AwsomeAlert from 'react-native-awesome-alerts';
...

                        {
                            ...
                            <FlatList
                                ...
                                renderItem={(itemData) => {
                                    ...
                                    const messageType = isOwnMessage ? "myMessage" : "otherMessages";
